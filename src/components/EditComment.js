...
export default function EditComment(props) {
  ...
  const oldComment = props.comment;
  ...
  useEffect(() => {
    setNewComment(props.comment.Comment);
  ...
  const saveComment = () => {
    ...
    axios.post("/api/EditComment.php", commentObj
    ,axiosConfig)
    .catch(e => {
    
    })
    .then((response) => {
          props.toggleModal(commentIndex, commentObj, false);
    });
    // props.toggleModal(commentIndex, commentObj, false);
  }
  ...
  return (
      <Dialog open={props.modalOpen} onClose={() => props.toggleModal(commentIndex, {}, false)} fullWidth maxWidth="sm" aria-labelledby="form-dialog-title">
        ...
        <DialogActions>
          <Button onClick={() => props.toggleModal(commentIndex, {}, false)} color="primary" variant="outlined">
            Cancel
          </Button>
